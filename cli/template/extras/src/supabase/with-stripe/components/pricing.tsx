...
import { checkoutWithStripe } from '@/features/subscriptions/actions';
    ...
    return (
      <section className="bg-black">
        <div className="max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8">
          ...
          <p className="text-4xl font-extralight text-white text-white sm:text-center sm:text-6xl">
              ...
              return (
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="mt-8">
                      <span className="text-5xl font-extralight text-white white">
                        {priceString}
                      </span>
